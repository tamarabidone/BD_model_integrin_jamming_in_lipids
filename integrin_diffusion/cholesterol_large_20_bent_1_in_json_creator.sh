...
s="cholesterol_large_20_bent_1_in_jsons/cholesterol_large_20_bent_1_in_"
# r is the relative path to str files without the number and ".str" extension (as seen from json location)
r="../cholesterol_large_20_bent_1_in_strs/cholesterol_large_20_bent_1_in_"
# x is the relative path to xyz files without the number and ".xyz"/".rst" extension (as seen from json location)
x="../cholesterol_large_20_bent_1_in_xyzs/cholesterol_large_20_bent_1_in_"
